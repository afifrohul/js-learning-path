...
class App extends React.Component {
  ...
  onAddNoteHandler({ title, body }) {
    ...
    const newNote = { id: +new Date(), title: title, body: body, createdAt: new Date(), archived: false };
    this.setState(() => {
      return {
  ...
  onArchiveHandler(id) {
    ...
    this.setState(() => {
      return {
        notes: this.state.notes.map((note) => note.id == id ? { ...note, archived: !note.archived } : note)
      };
    });
  }
